...
module.exports = {
  ...
  if (!message.member.hasPermission("ADMINISTRATOR")) return message.channel.send(`:no_entry: Bu komutu kullanabilmek için "\`Yönetici\`" yetkisine sahip olmalısın.`);
	if(!args[0]) return message.channel.send(new Discord.MessageEmbed()
                                          ...
                                          .setDescription(`
**t!botlist-ayar botekle-kanal #kanal**
**t!botlist-ayar botlog-kanal #kanal**
**t!botlist-ayar başvurugiden-kanal #kanal**
**t!botlist-ayar yetkili @rol**`)
                                          .setColor(message.guild.me.displayColor)
                                          )
  if(args[0] === "botekle-kanal"){
    if(db.has(`bot-ekle_${message.guild.id}`)) return message.channel.send("Bu kanal zaten ayarlanmış.Sıfırlamak için **t!botlist-ayar sıfırla**")
